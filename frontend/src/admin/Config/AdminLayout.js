  ...
  return (
    <div className={darkMode ? "app dark" : "app"}>
      <Routes>
        ...
        <Route path="lessons/new" element={<New inputs={lessonInputs} title={"Add New Lesson"} />} />
        <Route path="courses" element={<ManagerCourse />} />
        {/* <Route path="courses/:courseId/edit" element={<DetailCourse />} /> */}
        <Route path="courses/new" element={<New inputs={courseInputs} title={"Add New Course"} />} />
        <Route path="packageinfors" element={<ManagerPackgeInfor />} />
        <Route path="packageinfors/:packageinforId" element={<DetailPackageInfo />} />
        <Route path="packageinfors/new" element={<New inputs={packageInputs} title={"Add New Package Information"} />} />
